...
public class ZhuhuiMainActivity extends ActionBarActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.zhuhui_activity_main);
        AddTipFragment addTipFragment = new AddTipFragment();
        FragmentManager fm = getSupportFragmentManager();
        FragmentTransaction ft = fm.beginTransaction();
//        ft.(R.id.container, addTripFragment);
//        ft.commit();
        ft.add(R.id.zhuhui_container, addTipFragment).commit();
    }
    @Override
